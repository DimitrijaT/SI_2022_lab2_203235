...
#### Прв Начин:
Number of region  
Имаме 9 региони во сликата ги означив со портокалова боја, тоа е и цикломатската комплексност.
#### Втор Начин:
V(G) = E – N + 2  
...
#### Трет Начин:
V(G) = P + 1  
P = 8 е бројот на предикатни јазли  
V(G) = 8 + 1 = 9  
...
Откако тоа ќе се случи ќе проверам дали навистина во фрлениот исклучот ќе се појави стрингот "List length should be greater than 0".
...
Ако било кое од овие две е точно, продолжуваме на вториот вгнезден if и проверуваме дали и на левата и на десната страна се наоѓа бомба. Ако да, бројот се зголемува за 2, ако не се зголемува само за 1.
...
Во овој дел, првиот if се поставува прашање дали над него се наоѓа бомба, ако да, бројачот за бомби се зголемува за 1.
Во вториот if се поставува прашање дали под него се наоѓа бомба, ако да, бројачот за бомби се зголемува за 1.
